      ...
      <HowSection>
        ...
        <HowList>
          ...
          >
            ...
            <h4>Planning</h4>
            <p>
              We&#39;ll create a detailed plan outlining your goals and the steps
              needed to achieve them effectively.
            </p>
          </HowItem>
          <HowItem
            ref={(el) => {
          ...
          >
            ...
            <h4>Development</h4>
            <p>
              We begin the design and development process, creating custom
